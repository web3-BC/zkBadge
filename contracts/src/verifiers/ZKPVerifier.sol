...
contract ZKPVerifier is IZKPVerifier, Ownable {
    ...
    mapping(uint64 => bool) public requestExist;
     ...
     * @dev getZKPRequest
     */
    function getZKPRequest(uint64 requestId) external view override returns (ICircuitValidator.CircuitQuery memory) {
